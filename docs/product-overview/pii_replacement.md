...
LLM-assisted plan enhancement sends bounded raw cell samples to the configured
endpoint. Enable it only when that endpoint is approved to receive the input
data.
